...
enum
{
ARTEFACT_EFFECT_ENERGY,
ARTEFACT_EFFECT_MINERAL,
ARTEFACT_EFFECT_CRYSTAL,
ARTEFACT_EFFECT_ECTROLIUM,

ARTEFACT_EFFECT_UPKEEP,
ARTEFACT_EFFECT_POPULATION,

ARTEFACT_EFFECT_SPEED,
ARTEFACT_EFFECT_ATTACK,
ARTEFACT_EFFECT_DEFENCE,

ARTEFACT_EFFECT_BUILDING,
ARTEFACT_EFFECT_UNIT,

ARTEFACT_EFFECT_PLANET,

ARTEFACT_EFFECT_RESEARCH_LIMIT,
ARTEFACT_EFFECT_RESEARCH_RATE,

ARTEFACT_EFFECT_OPPERATION,
ARTEFACT_EFFECT_SPELL,
ARTEFACT_EFFECT_INCANTATION,

ARTEFACT_EFFECT_NUMUSED,
};
...
CMD_FLEET_ORDER_ESPIONAGE,
CMD_FLEET_ORDER_STEALRES,
...
CMD_FLEET_ORDER_ARMS,

CMD_FLEET_ORDER_NUMUSED
};

#define CMD_FLEET_ORDER_FIRSTOP (7)
#define CMD_FLEET_ORDER_LASTOP (7+12)

#define CMD_FLEET_ORDER_FIRSTINCANT (7+12)
#define CMD_FLEET_ORDER_LASTINCANT (7+12+8)
...
#define CMD_NEWS_FLAGS_OBSERVE 0x20

enum{
ANCIENTEXPLO_NUKED, //
ANCIENTEXPLO_HOSTILE, //
ANCIENTEXPLO_RCUP, //
ANCIENTEXPLO_FRUP, //
ANCIENTEXPLO_MAXFRUP, //
ANCIENTEXPLO_FRDOWN, //
ANCIENTEXPLO_ENLIGHT, //
ANCIENTEXPLO_RESGAIN, //
ANCIENTEXPLO_RESLOSS, //
ANCIENTEXPLO_REVEALARTI,  //
ANCIENTEXPLO_GIVEUNITS, 
ANCIENTEXPLO_KILLUNITS, //
ANCIENTEXPLO_GETCITIESANDPOP, //
ANCIENTEXPLO_GETMANYPLANETS, //

ANCIENTEXPLO_NUMUSED
};
...
CMD_NEWS_OPESPIONAGE_TARGET,
CMD_NEWS_OPSTEALRES_TARGER,
CMD_NEWS_OPRESERVED3T,

CMD_NEWS_OPCANCEL,
CMD_NEWS_OPCANCEL_BEACON,
...
CMD_NEWS_ENLIGHT_TARGET,
CMD_NEWS_SPGROWPLANET_TARGET,
...
#define CMD_NEWS_NUMOPEND (CMD_NEWS_OPSTEALRES)
#define CMD_NEWS_NUMOPTARGETBEGIN (CMD_NEWS_OPSPYTARGET_TARGET)
#define CMD_NEWS_NUMOPTARGETEND (CMD_NEWS_OPSTEALRES_TARGER)

#define CMD_NEWS_NUMSPBEGIN (CMD_NEWS_SPIRRAECTRO)
#define CMD_NEWS_NUMSPEND (CMD_NEWS_SPGROWPLANET)
#define CMD_NEWS_NUMSPTARGETBEGIN (CMD_NEWS_SPIRRAECTRO_TARGET)
#define CMD_NEWS_NUMSPTARGETEND (CMD_NEWS_SPGROWPLANET_TARGET)

#define CMD_NEWS_NUMINBEGIN (CMD_NEWS_INSENSE)
#define CMD_NEWS_NUMINEND (CMD_NEWS_INARMS)
#define CMD_NEWS_NUMINTARGETBEGIN (CMD_NEWS_INSENSE_TARGET)
#define CMD_NEWS_NUMINTARGETEND (CMD_NEWS_INARMS_TARGET)
...
#define CMD_RACE_SPECIAL_WOOKIEE 32
...
INFOS_MINERAL_INTEREST,

INFOS_CRYSTAL_PRODUCTION,
INFOS_CRYSTAL_DECAY,
INFOS_CRYSTAL_INTEREST,

INFOS_ECTROLIUM_PRODUCTION,
INFOS_ECTROLIUM_INTEREST,
...
INFOS_BENEFACTORS_NUM,
INFOS_BENEFACTORS_REDUCTION,

INFOS_AUTOFUND_RESEARCH,
INFOS_AUTOFUND_EMPIRE,
